...
<img src="Assignment1_part_2.gif" width=250><br>

### Notes

Putting in the glide transformation caused some design issues but I was able to fix it. Fixed an issue in which
the placeholder image was to big to fit on screen but it only took a simple folder change to fix. ButterKnife was simple 
to implement.  
